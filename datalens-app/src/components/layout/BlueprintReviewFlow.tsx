  ...
  return (
    <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6 animate-fade-in">
      <div className="flex items-start justify-between gap-6">
        <div>
          <h2 className="text-2xl font-bold text-slate-100">Revisión del Blueprint</h2>
          <p className="text-sm text-slate-400 mt-1 max-w-3xl">
            Revisá las decisiones estructurales y de normalización antes de persistir el dataset.
            El archivo original queda intacto; todo el análisis posterior usará el dataset normalizado.
          </p>
        </div>
      ...
      <div className="flex items-center justify-between gap-4 rounded-2xl border border-border-dark bg-surface-dark/60 px-5 py-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            Esto ejecuta el blueprint aprobado, guarda original y normalizado, y corre la validación SQL final.
          </p>
        </div>
        <button
